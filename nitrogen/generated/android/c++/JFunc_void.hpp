...
namespace margelo::nitro::screenshotmanager {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/screenshotmanager/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/screenshotmanager/Func_void_cxx;";
