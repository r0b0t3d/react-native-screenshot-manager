...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/screenshotmanager/`](android/src/main/java/com/margelo/nitro/screenshotmanager/): All Kotlin implementations.
    - [`ScreenshotMangerPackage.java`](android/src/main/java/com/margelo/nitro/screenshotmanager/ScreenshotMangerPackage.java): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.java` file. In here, you can autolink all Kotlin HybridObjects.
